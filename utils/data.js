...
const renovationData = {
  ...
  comprehensive: {
    ...
    items: [
      ...
      { id: 'custom_cabinet', name: '定制柜', price: 780, unit: '平', category: 'comprehensive' },
      { id: 'invisible_security_net', name: '隐形防盗网', price: 180, unit: '平', category: 'comprehensive' },
      { id: 'grout', name: '美缝（美缝剂）', price: 30, unit: '平', category: 'comprehensive' },
      { id: 'stairs_fee', name: '楼梯房上楼费', price: 0.02, unit: '总价', category: 'comprehensive' },
